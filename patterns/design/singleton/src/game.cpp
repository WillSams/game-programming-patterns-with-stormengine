...
Game::Game() {
    ...
    logger->Log("Singleton pattern example constructor called");
}

Game::~Game() { logger->Log("Singleton pattern example destructor called"); }
...
void Game::Initialize() {
    ...
    window = SDL_CreateWindow("Singleton Pattern Example",
