...
Describe(SettingsSingletonSpec) {
    ...
    It(clamps_volume_to_the_valid_range) {
    ...
    It(advances_difficulty_when_cycled) {
    ...
    It(wraps_difficulty_after_three_cycles) {
    ...
    It(leaks_state_between_tests_unless_reset) {
