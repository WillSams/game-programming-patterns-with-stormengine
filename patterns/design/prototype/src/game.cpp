...
Game::Game() {
    ...
    logger->Log("Prototype pattern example constructor called");
}

Game::~Game() { logger->Log("Prototype pattern example destructor called"); }
...
void Game::Initialize() {
    ...
    window = SDL_CreateWindow("Prototype Pattern Example",
