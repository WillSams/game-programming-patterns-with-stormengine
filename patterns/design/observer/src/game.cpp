...
Game::Game() {
    ...
    logger->Log("Observer pattern example constructor called");
}

Game::~Game() { logger->Log("Observer pattern example destructor called"); }
...
void Game::Initialize() {
    ...
    window = SDL_CreateWindow("Observer Pattern Example",
