...
Game::Game() {
    ...
    logger->Log("State pattern example constructor called");
}

Game::~Game() { logger->Log("State pattern example destructor called"); }
...
void Game::Initialize() {
    ...
    window = SDL_CreateWindow("State Pattern Example",
