...
Game::Game() {
    ...
    logger->Log("Pattern example constructor called");
}

Game::~Game() { logger->Log("Pattern example destructor called"); }
...
void Game::Initialize() {
    ...
    window = SDL_CreateWindow("Spatial Partition Pattern Example",
