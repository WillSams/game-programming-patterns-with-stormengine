...
Game::Game() {
    ...
    logger->Log("Command pattern example constructor called");
}

Game::~Game() { logger->Log("Command pattern example destructor called"); }
...
void Game::Initialize() {
    ...
    window = SDL_CreateWindow("Command Pattern Example",
