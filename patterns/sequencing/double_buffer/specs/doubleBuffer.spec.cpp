...
Describe(DoubleBufferSpec) {
    ...
    It(should_read_the_seed_as_the_current_value) {
        DoubleBuffer<int> b(7);
        Assert::That(b.current(), Equals(7));
    };

    It(should_hide_writes_to_next_until_a_swap) {
    ...
    It(should_keep_the_two_buffers_independent) {
